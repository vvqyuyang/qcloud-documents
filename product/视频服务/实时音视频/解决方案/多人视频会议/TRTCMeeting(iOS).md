...
| API                                     | 描述                                                         |
| --------------------------------------- | ------------------------------------------------------------ |
| [getBeautyManager](#getbeautymanager) | 获取美颜管理对象 [TXBeautyManager](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TXBeautyManager__ios.html)。 |
...
| fillMode | TRTCVideoFillMode | 填充或适应模式，默认值：填充（TRTCVideoFillMode_Fill），详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloud__ios.html#afda6658d1bf7dc9bc1445838b95d21ff)。 |
...
| rotation | NSInteger | 顺时针旋转角度, 详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloud__ios.html#a2ef26a9ede0ba4fa6c5739229e1eee90)。 |
...
| 参数       | 类型                | 含义                                                         |
| ---------- | ------------------- | ------------------------------------------------------------ |
| resolution | TRTCVideoResolution | 视频分辨率, 详细请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__ios.html#gaa58db9156c82d75257499cb5e0cdf0e5)。 |
...
| 参数    | 类型 | 含义                                                         |
| ------- | ---- | ------------------------------------------------------------ |
| bitrate | int  | 码率，SDK 会按照目标码率进行编码，只有在网络不佳的情况下才会主动降低视频码率。详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__ios.html#a21a93f89a608f4642ecc9d81ef25a454)。 |
...
| 参数 | 类型                     | 含义                                                         |
| ---- | ------------------------ | ------------------------------------------------------------ |
| type | TRTCLocalVideoMirrorType | 镜像模式。详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__ios.html#a21a93f89a608f4642ecc9d81ef25a454)。 |
...
| 参数    | 类型             | 含义                                                         |
| ------- | ---------------- | ------------------------------------------------------------ |
| quality | TRTCAudioQuality | 音频质量。详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloud__ios.html#a2cdffa1529fcaec866404f4f9b92ec53)。 |
...
| 参数 | 类型 | 含义                                                         |
| ---- | ---- | ------------------------------------------------------------ |
| mute | BOOL | 静音/取消静音。详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloud__ios.html#a4ada386a75d8042a432da05fde5552d9)。 |
...
| 参数   | 类型                     | 含义                                                         |
| ------ | ------------------------ | ------------------------------------------------------------ |
| params | TRTCAudioRecordingParams | 录音参数。详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDef__ios.html#interfaceTRTCAudioRecordingParams)。 |
...
>? 详情请参见[TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloud__ios.html#a92330045ce479f3b5e5c6b366731c7ff)
...
获取美颜管理对象 [TXBeautyManager](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TXBeautyManager__ios.html)。
...
>? 详情请参见 [TRTC SDK](http://(https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TRTCCloudDelegate__ios.html#a723002319845fbfc03db501aa9da6c28)。
